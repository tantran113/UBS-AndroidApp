...
public class clubDiscussionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView discussionPost = (TextView)findViewById(R.id.discussionPost);
        Bundle i = getIntent().getExtras();
       // String item = i.getStringExtra("item");
       // setTitle(item);

        String topic = i.getString("discussionItem");
        ...
        a.add("discusion comment 1");
        a.add("discusion comment 2");
        a.add("discusion comment 3");


        listViewAdapter = new ArrayAdapter<String>(clubDiscussionActivity.this,R.layout.listview_custom,R.id.list_item,a);
        final ListView discussionListView = (ListView) findViewById(R.id.discussionListView);
